...
{
    internal class GraphInterfaceMassiveResourcesBuilder
    {
        private readonly IEnumerable<IEnumerable<string>> _values;
        private readonly string _format;
        public GraphInterfaceMassiveResourcesBuilder(string format, IEnumerable<IEnumerable<string>> values)
        {
            _format = format;
            _values = values;
        }
        ...
        public List<string> Build()
        {
            ...
            {
                resources.Add(string.Format(_format, param.ToArray()));
            }
